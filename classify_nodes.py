...
def getRegionMetricRow(fname = "nodules.npy"):
    ...
    avgArea = totalArea / numNodes #avgArea：像素点平均数
    avgEcc = avgEcc / numNodes#结节圆平均离心率
    avgEquivlentDiameter = avgEquivlentDiameter / numNodes#平均同面积圆直径
    stdEquivlentDiameter = np.std(eqDiameters)

    maxArea = max(areas)


    numNodesperSlice = numNodes*1. / nslices#平均每张图片的结节数量
