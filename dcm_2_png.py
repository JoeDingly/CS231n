...
if __name__ == '__main__':
    for i in range(1017, 1109):
        dicom_dir = '/home/chen/dataset/{}/arterial phase'.format(i)
        ...
        for j in tqdm(range(image.shape[0])):
            img_path = '/home/chen/dataset/{}/arterial phase/'.format(i) + str(10001 + j) + '.png'
            # 将像素值归一化到[0,1]区间
            org_img = normalize_hu(image[j])
            # 保存图像数组为灰度图(.png)
